module.exports = {
    ...
    coverageThreshold: {
      global: {
        branches: 50,      // minimum 80% of conditional branches covered
        functions: 50,     // minimum 80% of functions covered
        lines: 50,         // minimum 80% of lines covered
        statements: 50     // minimum 80% of statements covered
      }
    }
  };
